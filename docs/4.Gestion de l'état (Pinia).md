...
Le store est maintenant **persistant** grâce à l'utilisation de `localStorage`. Si on rafraichit la page, Pinia ira chercher le token stocké pour reconstruire l'état de l'authentification.
